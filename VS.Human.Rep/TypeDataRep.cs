...
{
    public class TypeDataRep : RepositoryBase<TypeData>, ITypeDataRep
    {

        public TypeDataRep(IConfiguration configuration)
            : base(configuration)
        {
        ...
        Task<Candidate> ITypeDataRep.GetById(int id)
        {
