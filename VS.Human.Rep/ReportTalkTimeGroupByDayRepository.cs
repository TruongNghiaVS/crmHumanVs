...
namespace VS.Human.Rep
{
    public class ReportTalkTimeGroupByDayRepository : RepositoryBase<ReportTalkTimeGroupByDay>, IReportTalkTimeGroupByDay
    {
        ...
        public ReportTalkTimeGroupByDayRepository(IConfiguration configuration)
            : base(configuration)
        {

            tableName = "ReportTalkTimeGroupByDay";
        }
        ...
        public async Task<int> Add(ReportTalkTimeGroupByDay entity)
        {
            ...
            try
            {
                //await ExecuteSQL(_Sql.ReportTalkTimeGroupByDay_insert, par);
        ...
        public async Task Delete(ReportTalkTimeGroupByDay entity)
        {

        }
        public async Task<ReportTalkTimeGroupByDay> GetByIdAsync(string id)
        {
            return await this.GetById(int.Parse(id));
        ...
        public async Task<GetAllRecordGroupByLineCodeReponse> ProcessCalReportGroupByDay(GetAllRecordGroupByLineCodeRequest request)
        {
        ...
        public async Task<GetAllRecordGroupByLineCodeReponse> GetAll(GetAllRecordGroupByLineCodeRequest request)
        {
            int page = request.Page;
            int limit = request.Limit;
            var result = await GetDataList<GetAllRecordGroupByLineCodeIndexModel>(_Sql.GetAllRecordGroupByLineCode_getAll, new
            {
                request.Token,
                request.From,
                request.To,
            ...
            if (fistElement != null)
            {
                totalRecord = fistElement.TotalRecord.HasValue == true ? fistElement.TotalRecord.Value : 0;
            }
