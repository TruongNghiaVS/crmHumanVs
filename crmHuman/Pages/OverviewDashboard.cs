...
{
    [Authorize]
    public class OverviewDashboardModel : BaseModel2
    {
        private readonly ILogger<OverviewDashboardModel> _logger;
        ...
        public GetOverViewDashboard RequestSearch { get; set; }
        public BaseList DataAll { get; set; }

        public BaseList DataStatus { get; set; }

        public dynamic DataOverview { get; set; }
        ...
        public OverviewDashboardModel(ILogger<OverviewDashboardModel> logger,
        ...
        public async Task<ActionResult> OnGet([FromQuery] GetOverViewDashboard request)
        {
        ...
        public async Task<ActionResult> GetAll(GetOverViewDashboard request2)
        {
            request2.UserId = UserData.UserId.ToString();
            var inputRequest = new GetOverViewDashboard();
            ...
            DataOverview = await _reoportBussiness.GetOverViewDashBoard(inputRequest);
