...
{
    [Authorize]
    public class OrderAssigneeCTVModel : BaseModel2
    {
        private readonly ILogger<OrderAssigneeCTVModel> _logger;
        ...
        public OrderAssigneeCTVModel(ILogger<OrderAssigneeCTVModel> logger,
            ...
            )
        {
            ...
            TableColumnText = new List<string>()
            {
                ...
                "Đối tác/dự án","Trạng thái", "Ngày nhận","Người tạo","Ngày tạo",
        ...
        public async Task<IActionResult> OnPostAssingee(OrderAssingeeAdd request)
        {
            ...
            var result = await _empBusiness.Assignee(request);
            var dataReponse = new
            {
                success = result,
